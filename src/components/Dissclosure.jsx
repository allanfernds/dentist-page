...
function Dissclosure({ title, description }) {
  return (
    <section className="my-2">
      <details
        open
        className="w-70 sm:w-96 bg-slate-50 p-4 rounded-xl shadow-md group mx-auto max-h-[56px] open:!max-h-[400px] transition-[max-height] duration-500 overflow-hidden"
      >
